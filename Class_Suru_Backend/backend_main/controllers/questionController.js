import { 
  ...
  */
  ...
  try {
    const { exam_id, question_text,question_img_url, option_1,option_2,option_3,option_4,correct_marks, correct_option,wrong_marks, question_ans, question_ans_img  } = req.body;
  
    // ✅ Validate input fields
    if (!exam_id || !question_text || !question_img_url || !option_1 || !option_2 || !option_3 || !option_4) {
    ...
    await createQuestionModel(exam_id, question_text,question_img_url, option_1,option_2,option_3,option_4,correct_marks, correct_option,wrong_marks, question_ans, question_ans_img);
